    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>Ajuste os volumes e as opções de silenciar</DialogDescription>
        </DialogHeader>
        <div className="space-y-6 py-4">
          {/* Master Volume */}
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <label className="font-medium text-sm">Volume geral</label>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <label className="font-medium text-sm">Volume do rádio</label>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <label className="font-medium text-sm">Efeitos sonoros</label>
          ...
          <div className="border-t pt-4">
            ...
            >
              {muted ? <VolumeX className="size-4" /> : <Volume2 className="size-4" />}
              {muted ? 'Ativar todos os sons' : 'Silenciar todos os sons'}
            </Button>
          </div>
        </div>
      </DialogContent>
