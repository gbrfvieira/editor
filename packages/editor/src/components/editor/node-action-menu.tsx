...
export function NodeActionMenu({
  ...
  return (
    ...
    >
      {onFind && (
        <button
          aria-label="Encontrar no catálogo"
          className="tooltip-trigger rounded-md p-1.5 text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
          onClick={onFind}
          title="Encontrar no catálogo"
          type="button"
        >
      ...
      {onAddHole && (
        <button
          aria-label="Recortar abertura"
          className="tooltip-trigger rounded-md p-1.5 text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
          onClick={onAddHole}
          title="Recortar abertura"
          type="button"
        >
